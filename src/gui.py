...
class Filters(wx.Panel):
    def __init__(self, parent):
        ...
        self.datePickerFrom = wx.adv.DatePickerCtrl(
            self, style=wx.adv.DP_DROPDOWN | wx.adv.DP_SHOWCENTURY, size=(-1, -1)
        )
        self.stDateTo = wx.StaticText(self, label=load_text("txSpinDateTo") + ": ")
        self.datePickerTo = wx.adv.DatePickerCtrl(
            self, style=wx.adv.DP_DROPDOWN | wx.adv.DP_SHOWCENTURY, size=(-1, -1)
        )
        ...
        self.stAccessionNumber = wx.StaticText(
            self, label=load_text("txAccessionNumber") + ": "
        )
        self.tcAccessionNumber = wx.TextCtrl(
        ...
        gbSizerFiltresWidgets.Add(
            self.datePickerFrom, pos=(0, 2), flag=wx.EXPAND | wx.ALL, border=3
        )
        gbSizerFiltresWidgets.Add(
            self.stDateTo, pos=(1, 1), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALL, border=3
        )
        gbSizerFiltresWidgets.Add(
            self.datePickerTo, pos=(1, 2), flag=wx.EXPAND | wx.ALL, border=3
        )
        gbSizerFiltresWidgets.Add(
            self.btnToday, pos=(0, 0), flag=wx.EXPAND | wx.ALL, border=3
        )
        gbSizerFiltresWidgets.Add(
            self.btnLastWeek, pos=(1, 0), flag=wx.EXPAND | wx.ALL, border=3
        )
        gbSizerFiltresWidgets.Add(
            self.btnLastMonth, pos=(2, 0), flag=wx.EXPAND | wx.ALL, border=3
        )
        ...
        gbSizerFiltresWidgets.Add(
            self.tcPatientId, pos=(0, 4), flag=wx.EXPAND | wx.ALL, border=3
        )
        gbSizerFiltresWidgets.Add(
            self.stLastName,
            pos=(1, 3),
        ...
        gbSizerFiltresWidgets.Add(
            self.tcLastName, pos=(1, 4), flag=wx.EXPAND | wx.ALL, border=3
        )
        gbSizerFiltresWidgets.Add(
            self.stFirstName,
            pos=(2, 3),
        ...
        gbSizerFiltresWidgets.Add(
            self.tcFirstName, pos=(2, 4), flag=wx.EXPAND | wx.ALL, border=3
        )
        gbSizerFiltresWidgets.Add(
            self.stAccessionNumber,
            pos=(0, 5),
            flag=wx.ALIGN_CENTER_VERTICAL | wx.ALL,
            border=3,
        )
        gbSizerFiltresWidgets.Add(
            self.tcAccessionNumber, pos=(0, 6), flag=wx.EXPAND | wx.ALL, border=3
        )
        gbSizerFiltresWidgets.Add(
            self.btnSearch,
            pos=(2, 5),
        ...
        self.sbSizerFilters.Add(
            gbSizerFiltresWidgets, 1, wx.EXPAND | wx.ALL | wx.CENTER, border=3
        )
...
class Worklist(wx.Panel):
    def __init__(self, parent):
        ...
        self.dvcWorklist = wx.dataview.DataViewListCtrl(
            self, style=wx.dataview.DV_VERT_RULES | wx.dataview.DV_SINGLE, size=(0, 250)
        )
...
class EnteredStudy(wx.Panel):
    def __init__(self, parent):
        ...
        self.stPatientName = wx.StaticText(
            self, label=load_text("txPatientName") + ": "
        )
        ...
        sbSizerEntered.Add(
            self.btnManualInput, 0, wx.HORIZONTAL | wx.ALIGN_RIGHT, border=5
        )
        # -------------------------------------
...
class Files2Send(wx.Panel):
    def __init__(self, parent):
        ...
        self.lbLoadedFiles = wx.ListBox(
            self, style=wx.LB_SINGLE | wx.BORDER_SUNKEN, size=(0, 150)
        )
...
class Preview(wx.Panel):
    def __init__(self, parent):
        ...
        # „Error label“ - bude zobrazen jen v případě, že bitmapa není platná
        self.stError = wx.StaticText(self, label="", style=wx.ALIGN_CENTER)
        ...
        topSizer.AddStretchSpacer(1)  # Pushes the StaticText to the right
        topSizer.Add(self.stError, 0, wx.ALL | wx.CENTER)
        ...
        mainSizer.Add(topSizer, 0, wx.ALL | wx.EXPAND)
...
class ManualInput(wx.Dialog):
    def __init__(self, parent):
        ...
        if os.path.exists(small_icon_path):
            ...
            logger.warning(
                f"Icon cannot be loaded. Wrong path? Current path is {os.getcwd()} Icon must be in dir program_folder/src/img"
            )
        ...
        gridBagSizer.Add(
            self.stPatientId, pos=(0, 0), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
        gridBagSizer.Add(self.tcPatientId, pos=(0, 1), flag=wx.EXPAND)
        gridBagSizer.Add(
            self.stFirstName, pos=(1, 0), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
        gridBagSizer.Add(self.tcFirstName, pos=(1, 1), flag=wx.EXPAND)
        gridBagSizer.Add(
            self.stLastName, pos=(2, 0), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
